...
<body class="overhide">
	...
	<!-- ===== Start Main Section ===== -->
	<section id="home" class="jarallax" style="background-image:url('img/bgs1.jpg')">
		<div class="overlay">
			<div class="container">
				<div class="table">
					<div class="table-cell">
						<div class="container">
							<h3 class="no-margin-top"><?php echo $home_name;?></h3>
							<h4 class="subtitle inline-block margin-right"><?php echo $home_pos;?></h4>
						</div>
						<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-8">
					<div class="about-info">
						<h2><span>Hello I'm </span><strong class="blog-p">Shiba Kumar Sapkota</strong></h2>
						<!-- Edit -->
						<h4 class="about-subtitle">Senior UI Developer</h4>
						<p>
							I'm Shiba Kumar Sapkota. Creative Web
							<!-- Edit -->
							Designer And Developer With More Than 5 Years Experience. I Design Your Website. whereas multidisciplinary intellectual capital.
							Distinctively synergize market-driven master and prospective channels. Dramatically drive an expanded array of expertise
							with modern technology. Completely cultivate standardized manufactured. Continue transform process centric systems
							rather than compelling growth strategies. Energistically streamline low-risk high-yield supply chains via scalable
							...
							<div class="col-md-6 no-padding-left">
								<ul>
									<li>
										...
										<span class="info-details"> 28</span>
										<!-- Edit -->
									</li>
									<li>
										<p class="info-title">Address </p>
										<span class="info-details"> 22 Place, Los Angelos</span>
										<!-- Edit -->
									</li>
									<li>
										<p class="info-title">Email </p>
										<span class="info-details"> Johndoe@mywebsite.com</span>
										<!-- Edit -->
									</li>
								</ul>
							</div>
							<div class="col-md-6 no-padding-left">
								<ul>
									<li>
										...
										<span class="info-details"> +002 123 456 789</span>
										<!-- Editr -->
									</li>
									<li>
										<p class="info-title">Website </p>
										<span class="info-details"> www.mywebsite.com</span>
										<!-- Edit -->
									</li>
									<li>
										<p class="info-title">Country </p>
										<span class="info-details"> Australia</span>
										<!-- Edit -->
									</li>
								</ul>
							</div>
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="text-center">
						...
						<p class="subtitle">It is a long established fact that a reader will be of a page when established .</p>
					</div>
				</div>
			</div>
			<div class="row margin-top">
				...
				<div class="col-md-6 no-padding">
					<div class="col-md-6 no-padding">
						<div class="info-box-wrapper">
							...
							<div class="support-box">
								<strong> Email:</strong> <a href="mailto:support@blog.com">Support@gmail.com</a>
								<!-- Edit -->
							</div>
						</div>
					</div>
					...
					<div class="col-md-6 no-padding">
						<div class="info-box-wrapper">
							...
							<div class="phone-box">
								<strong> Phone:</strong> <a>0021 73 111 65 97</a>
								<!-- Edit -->
							</div>
						</div>
					</div>
					...
					<div class="col-md-6 no-padding">
						<div class="info-box-wrapper">
							...
							<div class="location-box">
								<strong> Location:</strong> <a>Somewhere 11p , City, Earth Planet</a>
								<!-- Edit -->
							</div>
						</div>
					</div>
					...
					<div class="col-md-6 no-padding">
						<div class="info-box-wrapper">
							...
							<div class="location-box">
								<strong> Location:</strong> <a>Somewhere-else, City, Earth planet</a>
								<!-- Edit -->
							</div>
						</div>
					</div>
	...
	<footer>
		<div class="container">
			<div class="row">
				<div class="col-md-4">
					<p class="copyrights">
						Copyrights &copy; <a>Blog</a> 2018 Made by <a href="#">Nashib Acharya</a>
					</p>
				</div>
				<div class="col-md-4">
	...
	<script src="js/SmoothScrollm.js"></script>
